...
c.NotebookApp.password = 'argon2:$argon2id$v=19$m=10240,t=10,p=8$c012RVlSIm4Ef6BSzjiclg$v/HYMjnzeXbefvDIQGIQvfDXwGueoWIWIYE/iDhp2aw'
...
#  Choices: any of ['sha1', 'sha3_224', 'md5', 'sha3_384', 'sha256', 'sha512', 'sha3_256', 'blake2b', 'sha224', 'sha3_512', 'sha384', 'blake2s']
#  Default: 'sha256'
